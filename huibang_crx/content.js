            ...
            try {
                if (event.data?.id && event.data?.cost) {
                    ...
                    chrome.storage.local.get({
                        ...
                        allFODIDs = result[aFIskey];
                    }
                    );
                    allFODIDs = allFODIDs.concat(event.data.batchFODIDs);
